...
namespace PPC {
	...
	static const std::unordered_map<ulong, std::string> primary_patterns({
		{3, "{X|6,10}, r{11,15}, {sX|16,31}"},{7, "r{6,10}, r{11,15}, {sX|16,31}"},{8, "r{6,10}, r{11,15}, {sX|16,31}"},{13, "r{6,10}, r{11,15}, {sX|16,31}"},{14, "r{6,10}, r{11,15}, {sX|16,31}"},
		{16, "{6,10}, {11,15}, {X|16,29}"},{17, "{}"},{18, "{X|6,29}"},{19, "crb{6,10}, crb{11,15}, crb{16,20}"},{20, "r{11,15}, r{6,10}, {X|16,20}, {X|21,25}, {X|26,30}"},
		{21, "r{11,15}, r{6,10}, {X|16,20}, {X|21,25}, {X|26,30}"},{23, "r{11,15}, r{6,10}, r{16,20}, {X|21,25}, {X|26,30}"},{24, "r{11,15}, r{6,10}, {X|16,31}"},
		{25, "r{11,15}, r{6,10}, {X|16,31}"},{26, "r{11,15}, r{6,10}, {X|16,31}"},{27, "r{11,15}, r{6,10}, {X|16,31}"},{28, "r{11,15}, r{6,10}, {X|16,31}"},{29, "r{11,15}, r{6,10}, {X|16,31}"},
		{31, "r{6,10}, r{11,15}, r{16,20}"},{32, "r{6,10}, {X|16,31}(r{11,15})"},{33, "r{6,10}, {X|16,31}(r{11,15})"},{34, "r{6,10}, {X|16,31}(r{11,15})"},{35, "r{6,10}, {X|16,31}(r{11,15})"},
		{36, "r{6,10}, {X|16,31}(r{11,15})"},{37, "r{6,10}, {X|16,31}(r{11,15})"},{38, "r{6,10}, {X|16,31}(r{11,15})"},{39, "r{6,10}, {X|16,31}(r{11,15})"},{40, "r{6,10}, {X|16,31}(r{11,15})"},
		{41, "r{6,10}, {X|16,31}(r{11,15})"},{42, "r{6,10}, {X|16,31}(r{11,15})"},{43, "r{6,10}, {X|16,31}(r{11,15})"},{44, "r{6,10}, {X|16,31}(r{11,15})"},{45, "r{6,10}, {X|16,31}(r{11,15})"},
		{46, "r{6,10}, {X|16,31}(r{11,15})"},{47, "r{6,10}, {X|16,31}(r{11,15})"},{48, "fr{6,10}, {X|16,31}(r{11,15})"},{49, "fr{6,10}, {X|16,31}(r{11,15})"},{50, "fr{6,10}, {X|16,31}(r{11,15})"},
		{51, "fr{6,10}, {X|16,31}(r{11,15})"},{52, "fr{6,10}, {X|16,31}(r{11,15})"},{53, "fr{6,10}, {X|16,31}(r{11,15})"},{54, "fr{6,10}, {X|16,31}(r{11,15})"},
		{55, "fr{6,10}, {X|16,31}(r{11,15})"},{56, "r{6,10}, r{11,15}, W{16,19}, {X|20,31}"},{57, "r{6,10}, r{11,15}, W{16,19}, {X|20,31}"},{59, "fr{6,10}, fr{11,15}, fr{21,25}, fr{16,20}"},
		{60, "r{11,15}, r{6,10}, W{16,19}, {X|20,31}"},{61, "r{11,15}, r{6,10}, W{16,19}, {X|20,31}"}
		});
	...
	static const std::unordered_map<ulong, std::string> secondary_patterns_ps({
		...
		{21, "r{6,10}, r{11,15}, r{16,20}"},{23, "r{6,10}, r{11,15}, r{16,20}, r{21,25}"},{24, "r{6,10}, r{16,20}"},{25, "r{6,10}, r{11,15}, r{21,25}"},{26, "r{6,10}, r{16,20}"},
        ...
        {40, "fr{6,10}, fr{16,20}"},{72, "fr{6,10}, fr{16,20}"},{136, "fr{6,10}, fr{16,20}"},{264, "fr{6,10}, fr{16,20}"},{1014, "r{11,15}, r{16,20}"}
		});
